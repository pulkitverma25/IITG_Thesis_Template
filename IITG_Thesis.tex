...
\usepackage{tabularx}
\usepackage{Styles/lettrine}
\usepackage{multicol,Styles/ltablex,Styles/supertabular,latexsym}
\usepackage{amssymb,setspace,amsmath}
\usepackage{pdflscape}
\usepackage{url}
\usepackage{Styles/multirow}
\usepackage{Styles/threeparttable}
\usepackage{graphics}
\usepackage{epsfig}
\usepackage{epstopdf}
\usepackage{graphicx}
...
\usepackage{Styles/rotfloat}
\usepackage{textcomp}
\usepackage{Styles/multirow}
\usepackage[ american]{babel}
\usepackage{Styles/comment}

%%
\usepackage{Styles/morefloats}
\usepackage{verbatim}
\usepackage{Styles/mathastext} %[LGRgreek]
\usepackage{pdflscape}
\usepackage{Styles/changepage}
\usepackage{Styles/floatpag}
\usepackage{Styles/extra_functions}
...
\large \textbf{A} \\ \textbf{Thesis Submitted} \\ \textbf{in Partial Fulfillment of the Requirements} \\ \textbf{for the Degree of} \\ \textbf{\expandafter\uppercase\expandafter{\degreeName}} \\ \textbf{By} \\ [1.5cm] \textbf{\expandafter\uppercase\expandafter{\authorName}}\\  \textbf{Under the Supervision of Prof. \expandafter\uppercase\expandafter{\supervisorName}} \\[1.5cm] % University requirement text
